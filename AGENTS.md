...
This repository/branch is the hero-mmt-kit framework itself — the human-led, Claude-Code-only coding assistant kit. It is not a consumer project. Any agent working here:
